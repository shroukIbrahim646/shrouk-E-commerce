      ...
      <nav className="flex flex-col fixed  top-0  min-w-full shadow-md z-50">
        ...
        >
          <label htmlFor="" className="mx-3">
            <img src={"https://static.vecteezy.com/system/resources/previews/008/560/942/original/luxury-letter-s-logo-design-idea-with-leaf-name-initial-for-brand-or-company-vector.jpg"} alt="" className="w-10 h-9" />
          </label>
          ...
          <ul className="hidden  sm:flex ml-8 mt-1 text-lg">
            ...
            <NavLink to="/about" className="mx-6">
              <li className={`hover:border-b-4 border-orange-300 active:border-b-4 ${splitLocation[1] === "about" ? "border-b-4" : ""} `}>About us</li>
            </NavLink>
            <NavLink to="/contact" className="mx-6">
              <li className={`hover:border-b-4 border-orange-300 active:border-b-4 ${splitLocation[1] === "contact" ? "border-b-4" : ""} `}>contact us </li>
            </NavLink>
          </ul>
